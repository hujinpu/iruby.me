...
* Every class has exactly one superclass, with the exception of Basi- cObject (or Object if you’re using Ruby 1.8), which has none. This means you have a single ancestors chain from any class up to BasicObject.
